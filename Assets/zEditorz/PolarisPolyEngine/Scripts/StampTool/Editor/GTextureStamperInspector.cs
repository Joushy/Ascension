    ...
    public class GTextureStamperInspector : Editor
    {
        ...
        private void DrawLivePreview(GStylizedTerrain t, Camera cam)
        {
            ...
            if (instance.Channel == GTextureStampChannel.AlbedoMetallicSmoothness)
            {
                ...
                FilterMode albedoFilter = t.TerrainData.Shading.Internal_AlbedoMap.filterMode;

                int metallicResolution = t.TerrainData.Shading.MetallicMapResolution;
                FilterMode metallicFilter = t.TerrainData.Shading.Internal_MetallicMap.filterMode;
            ...
            else if (instance.Channel == GTextureStampChannel.Splat)
            {
                ...
                {
                    Texture currentControl = t.TerrainData.Shading.Internal_GetSplatControl(i);
        ...
        private void SetupSplatPreview(GStylizedTerrain t)
        {
            ...
            {
                Texture2D splatControl = t.TerrainData.Shading.Internal_GetSplatControl(i);
        ...
        private void SetupAlbedoMetallicSmoothnessPreview(GStylizedTerrain t)
        {
            ...
            if (mat == null)
                return;
            int albedoResolution = t.TerrainData.Shading.AlbedoMapResolution;
            RenderTexture previewAlbedo = GetPreviewTexture(t, "albedo", albedoResolution, t.TerrainData.Shading.Internal_AlbedoMap.filterMode);
            GCommon.ClearRT(previewAlbedo);

            int metallicResolution = t.TerrainData.Shading.MetallicMapResolution;
            RenderTexture previewMetallic = GetPreviewTexture(t, "metallic", metallicResolution, t.TerrainData.Shading.Internal_MetallicMap.filterMode);
