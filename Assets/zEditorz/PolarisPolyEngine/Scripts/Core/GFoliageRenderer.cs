...
namespace Pinwheel.Griffin
{
    public static class GFoliageRenderer
    {
        ...
        private static void RenderGrass(GStylizedTerrain t, Camera cam)
        {
            ...
            {
                grassMaterialPropertyBlock.SetTexture("_VectorField", t.GetGrassVectorFieldRenderTexture());
                grassMaterialPropertyBlock.SetMatrix("_WorldToNormalized", t.GetWorldToNormalizedMatrix());
            }
            ...
            if (windZone.MoveNext())
            {
                ...
                grassMaterialPropertyBlock.SetVector("_Wind", w.GetWindParams());
            }
