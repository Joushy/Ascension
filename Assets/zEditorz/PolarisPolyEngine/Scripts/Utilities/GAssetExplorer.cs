...
namespace Pinwheel.Griffin
{
    public class GAssetExplorer : MonoBehaviour
    {
        ...
        public static string POLARIS_LINK = "https://assetstore.unity.com/packages/tools/terrain/polaris-v2-ultimate-low-poly-terrain-engine-144645?aid=1100l3QbW&pubref=p2-editor";
