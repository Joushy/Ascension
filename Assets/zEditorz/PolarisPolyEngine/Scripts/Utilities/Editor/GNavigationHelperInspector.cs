...
namespace Pinwheel.Griffin
{
    ...
    public class GNavigationHelperInspector : Editor
    {
        ...
        private void DrawInstructionGUI()
        {
            ...
            {
                EditorGUILayout.LabelField("Create dummy game objects for Nav Mesh baking. These game objects should be remove in production.", GEditorCommon.WordWrapItalicLabel);
            });
        }
